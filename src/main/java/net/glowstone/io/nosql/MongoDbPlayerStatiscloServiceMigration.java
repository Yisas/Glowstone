...
public class MongoDbPlayerStatiscloServiceMigration  extends JsonPlayerStatisticIoService {
	...
	private MongoDbPlayerStatisticIoService mongoP = new MongoDbPlayerStatisticIoService(server, statsDir);
	private JsonPlayerStatisticIoService jsonP = new JsonPlayerStatisticIoService(server, statsDir);
